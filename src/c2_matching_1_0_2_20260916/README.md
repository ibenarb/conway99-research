Version 1.0.2 korrigiert den fehlgeschlagenen Windows-Replace-Aufruf aus 1.0.1 durch einen expliziten Backup-Pfad. Siehe FIX_1_0_2.md. Der echte Windows-Selbsttest bleibt verpflichtend.
