"""Test eleven dummy jobs with simulated resource telemetry."""
import json
import tempfile
...
def check():
    ...
    with patch.object(run_matching, "linux_safety", return_value={"output_bytes": 0}):
    ...
    return dict(status='PASS', completed=11, budget_limit_seconds=122400,
