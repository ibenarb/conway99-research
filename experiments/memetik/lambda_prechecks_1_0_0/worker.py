...
from experiment_engine import ExperimentEngine as Engine
from engine import increment
...
def main():
    ...
    atomic(directory/'result.json',{'status':state['status'],'best':state['best'],'curves':state['curves'],
           ...
           'complete_batches':state['complete_batches'],'experiment_metrics':state.get('experiment_metrics',{}),'endpoint_cpu_seconds':ceiling,
